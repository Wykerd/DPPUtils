...
**NOTE: This repo is in development, use these utilities at your own risk**

Numerous utilities for use in your DPP bot.

# List of Utilities
- Youtube Audio Player - [ytplayer](#ytplayer)

More utilities comming soon. Feel free to contribute your own!

# Using

## CMake
DPPUtils may be included as a cmake subdirectory within a DPP bot

## Copy Paste
You may also copy and paste the source files over to your bot if you prefer

# Documentation

## ytplayer <a id="ytplayer"></a>

Plays youtube streams using libytdl.
